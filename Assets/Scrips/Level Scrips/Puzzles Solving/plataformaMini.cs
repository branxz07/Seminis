...
public class plataformaMini : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        presionado = false;
        abajo = new Vector3(original.position.x, original.position.y - 0.018f, original.position.z);
    ...
    {
        if(other.name.Contains("OlmoCollect"))
        {
            objetosEnTrigger++;
            presionado = true;
        }
